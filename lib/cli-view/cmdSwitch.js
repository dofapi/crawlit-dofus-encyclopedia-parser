var cmdSwitch = exports.cmdSwitch = function(category) {
	switch (category) {
	  ...
	  case 'pet':
		...
		break;
	  case 'resource':
        url = 'https://www.dofus.com/fr/mmorpg/encyclopedie/ressources?size=500';
        break
      case 'consumable':
		url = 'https://www.dofus.com/fr/mmorpg/encyclopedie/consommables?size=500';
		break;
...
var cmdSwitchEn = exports.cmdSwitchEn = function(category) {
	switch (category) {
	  case 'all encyclopedia':
		url = 'https://www.dofus.com/en/mmorpg/encyclopedia/equipmentsize=3000';
		break;
	  case 'all equipments':
		url = 'https://www.dofus.com/en/mmorpg/encyclopedia/equipmentsize=3000';
		break;
	  ...
	  case 'resource':
		...
		break;
      case 'consumable':
	    url = 'https://www.dofus.com/en/mmorpg/encyclopedie/consumables?size=3000';
	    break;
	  default:
		console.log('Sorry, we are out of ' + category + '.');
	}
