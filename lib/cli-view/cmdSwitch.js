var cmdSwitch = exports.cmdSwitch = function(category) {
	switch (category) {
	  ...
	  case 'resource':
        ...
        break
      case 'consumable':
		url = 'https://www.dofus.com/fr/mmorpg/encyclopedie/consommables?';
		break;
...
var cmdSwitchEn = exports.cmdSwitchEn = function(category) {
	switch (category) {
	  ...
	  case 'pet':
		...
		break;
	  case 'resource':
		url = 'https://www.dofus.com/en/mmorpg/encyclopedia/resources?';
		break;
      case 'consumable':
	    url = 'https://www.dofus.com/en/mmorpg/encyclopedie/consumables?';
	    break;
	  default:
		console.log('Sorry, we are out of ' + category + '.');
	}
