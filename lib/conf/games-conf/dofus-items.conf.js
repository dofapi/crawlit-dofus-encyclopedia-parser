...
const getWeapons = require('../../modules/category-parsers/dofus/parsers/getWeapons').getWeapons;
...
const getConsumables = require('../../modules/category-parsers/dofus/parsers/getConsumables').getConsumables;
const getProfessions = require('../../modules/category-parsers/dofus/parsers/getProfessions').getProfessions;
const getHarnesses = require('../../modules/category-parsers/dofus/parsers/getHarnesses').getHarnesses;
const getIdols = require('../../modules/category-parsers/dofus/parsers/getIdols').getIdols;
