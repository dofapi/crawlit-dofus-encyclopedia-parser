...
function categoryClasse(language, game) {
	return inquirer.prompt(cliCategories.page).then(answers => {
		answers.language = language;
		answers.game = game;
...
function categoryIdol(language, game) {
	return inquirer.prompt(cliCategories.page).then(answers => {
		answers.language = language;
		answers.game = game;
...
module.exports = { categoryConsumable, categoryEquipment, categoryHarness, categoryMonster, categoryMount, categoryPet, categoryProfession, categoryResource, categorySet, categoryWeapon, categoryClasse, categoryIdol };