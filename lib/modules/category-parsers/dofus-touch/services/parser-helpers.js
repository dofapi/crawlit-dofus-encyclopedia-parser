...
module.exports = {
	...
	descriptionParse: (body, url) => {
		...
		else type = $('div.ak-encyclo-detail-right').find('div.ak-encyclo-detail-type').text().trim().split(':')[1] == undefined ? '' : $('div.ak-encyclo-detail-right').find('div.ak-encyclo-detail-type').text().trim().split(':')[1].trim();
